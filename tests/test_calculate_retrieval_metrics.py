...
"""
import pytest
from rag_evaluation.calculate_retrieval_metrics import string_format
from rag_evaluation.calculate_retrieval_metrics import get_keywords
from rag_evaluation.calculate_retrieval_metrics import get_source_relevance
from rag_evaluation.calculate_retrieval_metrics import precision_at_k
from rag_evaluation.calculate_retrieval_metrics import average_precision
from rag_evaluation.calculate_retrieval_metrics import mean_reciprocal_rank
from rag_evaluation.calculate_retrieval_metrics import cumulative_gain
from rag_evaluation.calculate_retrieval_metrics import normalized_discounted_cg
...
def test_simple_string_format():
    actual_string = string_format("This, is a simple STRING that needs. to be formatted")
...
def test_complex_keywords():
    actual = get_keywords("this is super duper complex set of keywords with this thing •*")
...
def test_source_relevance_simple_almost_relevant():
    assert get_source_relevance("super super super almost relevant source",
                                {"super"}) == 0


def test_source_relevance_simple_just_relevant():
    assert get_source_relevance("super super super super relevant source", 
                                {"super"}) == 1


def test_source_relevance_multiple_keywords_not_relevant():
    assert get_source_relevance("one two and there is no more",
                                {"one", "two", "three"}) == 0
...
def test_precision_at_k_simple():
    sources = ["query", "super super super super relevant source", "source2",
